 ...
 * @generated */
public class ShittySentenceID_Type extends TOP_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ShittySentenceID");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "ShittySentenceID");
